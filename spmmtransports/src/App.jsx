...
const CO = {
  ...
  addressLine: "3/172, South Street, Kavettipatty, Vallipura (PO), Namakkal – 637003",
};
...
const SEED_DATA = {
  customers: [
    { id:"C001", name:"Rajan Kumar",  email:"rajan@gmail.com",  phone:"9876543210", password:"pass123", address:"Chennai" },
    { id:"C002", name:"Priya Nair",   email:"priya@gmail.com",  phone:"9876543211", password:"pass123", address:"Coimbatore" },
    { id:"C003", name:"Kalimagal",  email:"kalai@gmail.com",  phone:"9003717432", password:"kalai123", address:"Namakkkal" },
  ...
  vehicles: [
    ...
    { id:"V002", number:"TN22CD5678", type:"32ft Trailer",    capacity:"10 Tons", available:true },
...
export default function App() {
  ...
  const login = (email, password, role) => {
    if (role === "admin") {
      if (email === "spmmtransports@gmail.com" && password === "admin123") {
  ...
  const register = (data) => {
    if (db.customers.find(c => c.gmail === data.gmail)) return "Email already registered.";
      ...
      <div style={{ background:C.white, borderRadius:18, padding:"32px 36px", width:"100%", maxWidth:430, boxShadow:"0 24px 64px rgba(0,0,0,0.5)" }}>
        {!regMode ? (
          <>
            ...
            {loginTab==="admin"    && <div style={{ fontSize:12, color:C.muted, marginBottom:14, background:"#FFF8DC", padding:"10px 12px", borderRadius:8 }}></div>}
            {loginTab==="customer" && <div style={{ fontSize:12, color:C.muted, marginBottom:14, background:"#EAF2FE", padding:"10px 12px", borderRadius:8 }}></div>}
